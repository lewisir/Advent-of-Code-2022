...
class BeaconZone:
    ...
    def exclusion_zone(self, sensor, distance) -> set:
    ...
    def exclusion_row(self, sensor, distance, row, limit=float(inf)) -> set:
    ...
    def populate_beacon_exclusion(self) -> None:
    ...
    def count_exclusion_points(self, row) -> int:
    ...
    def limited_empty_points(self, row, limit) -> int:
    ...
    def non_empty_points(self, row, limit) -> set:
    ...
    def inclusion_row(self, sensor, distance, row, limit=float(inf)) -> set:
